  ...
  <div class="detail">
    <div class="top">
       <div class="button-group">
         <el-button :size="$store.state.size" type="text" @click="downLoad">原始文件下载</el-button>
         <!--<el-button :size="$store.state.size" type="text">系统处理后文件下载</el-button>-->
         <!--<el-button :size="$store.state.size" type="text">数据分析汇总结果下载</el-button>-->
       </div>
      <el-table
        :data="detailData"
        border
    ...
    <div class="content-tab">
      <col-table :detailData="detailData"></col-table>
    </div>
  </div>
</template>

<script>
  import colTable from './tab/colTable.vue'
