  ...
  <div class="description">
    <div class="breadcrumb">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item><router-link to="/detection/region" >区域分布</router-link></el-breadcrumb-item>
        <el-breadcrumb-item><router-link :to="{path:'/detection/regionProvince',query:{province:$route.query.province,deptType:2}}" >{{$route.query.province}}</router-link></el-breadcrumb-item>
...
<script>
  ...
  export default {
    ...
    created(){
      this.query(3)
      this.allOverNation = this.$route.query.city
    },
    methods: {
      change(value){
