  ...
  <div class="description">
    <div class="breadcrumb">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item><router-link :to="{path:'/detection/province',query:{province:$route.query.province,drugsNum:$route.query.drugsNum}}" >{{$route.query.province}}</router-link></el-breadcrumb-item>
        <el-breadcrumb-item><span class="no-redirect">{{$route.query.city}}</span></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="search">
    ...
    <div class="table">
      ...
      <p class="table-row-title">截止到{{today | dateFormater}}，全国抗肿瘤药物累计使用{{queryResult.countryNum}}种，
        ...
        <span v-if="$route.query.city">{{$route.query.city}}累计使用{{$route.query.drugsNum1}}种</span>
      </p>
      <el-row style="margin-top: 30px;padding-bottom: 20px;">
        <el-col :span="8">
          <charts :options="option" style="width: 100%;"  :style="{height:height}" :autoResize=true v-if="echartState"></charts>
        </el-col>
        <el-col :span="16">
          <el-table
            size="small"
            ...
            >
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}" v-if="scope.row.drugsNum/1>0">
            ...
            <el-table-column
              label="化学药物">
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'1',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}"  v-if="scope.row.chemicalDrugsNum/1>0">
            ...
            <el-table-column
              label="靶向药物">
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'2',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}"  v-if="scope.row.targetedDrugsNum/1>0">
            ...
            <el-table-column
              label="免疫药物">
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'3',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}"  v-if="scope.row.immunologicalDrugsNum/1>0">
            ...
            <el-table-column
              label="内分泌药物">
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'4',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}"  v-if="scope.row.endocrineDrugsNum/1>0">
            ...
            <el-table-column
              label="其他药物">
              <template slot-scope="scope">
                <router-link :to="{path:'/detection/drugList',query:{province:$route.query.province,city:$route.query.city,drug:'5',hospital:scope.row.hospital,tableTitle:scope.row.hospital}}"  v-if="scope.row.otherNum/1>0">
