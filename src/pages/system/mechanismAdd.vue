     ...
     <div class="mechanism-item basic-info">
       ...
       <div class="info">
           <el-form-item label="机构名称：" prop="deptName">
             <el-input v-model="ruleForm.deptName" class="mechanism-input" :disabled="disabledState"></el-input>
           </el-form-item>
           ...
           <el-form-item label="" style="float:left" prop="deptCity">
          ...
          <el-form-item label="" style="float:left" prop="deptDistrict"　>
    ...
    <div class="mechanism-item basic-info disabled">
      ...
      <div class="info">
            ...
            <el-radio-group v-model="ruleForm.deptType" @change="selectCountryType" :disabled="disabledState">
              ...
              <el-radio :label="2" value="2" style="margin-top:20px;line-height: 40px;">
                ...
                <span v-if="ruleForm.deptType == 2">
                  <el-select  placeholder="请选择医疗机构" style="width:200px"  v-model="ruleForm.hospitalType" :disabled="disabledState">
                    <el-option label="综合医院" value="1"></el-option>
                    <el-option label="专科医院" value="2"></el-option>
                    <el-option label="其他" value="3"></el-option>
                  </el-select>
                  &nbsp;&nbsp;医院等级&nbsp;&nbsp;
                  <el-select  placeholder="请选择医院等级" style="width:200px"  v-model="ruleForm.hospitalGrade" :disabled="disabledState">
                    <el-option
        ...
        <el-form-item label="隶属机构：" prop="deptPid" v-if="$route.query.type == 2">
          <el-input v-model="ruleForm.subjectionInstitutionName"  :disabled="disabledState" style="width:200px"></el-input>
        </el-form-item>
